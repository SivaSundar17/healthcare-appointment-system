...
const API_URL = 'http://localhost:8001'; // Auth Service
const USER_SERVICE_URL = 'http://localhost:8002'; // User Service
const DOCTOR_SERVICE_URL = 'http://localhost:8003'; // Doctor Service
